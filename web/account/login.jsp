            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab" tabindex="0">
                    <form action="<c:url value="/user/login"/>" method="POST">
                        <div class="form-floating mb-2">
                            <input type="email" class="form-control rounded-0" id="emailLogin" placeholder="user@example.com" aria-describedby="emailHelp" name="email" required value="${user.email}">
                            <label for="emailLogin" class="form-label required-field">Email address</label>
                            <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                        </div>
                        <div class="form-floating mb-2">
                            <input type="password" class="form-control rounded-0" id="passwordLogin" placeholder="Password" name="password" required value="${user.email}">
